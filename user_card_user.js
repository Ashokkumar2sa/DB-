...
(async () => {
    ...
    for(var i =1;i<1000;i++){
          ...
          var l_name = makeid(1)+ makeids(Math.floor(Math.random()*(3)+5));
          await page.fill('input[name="lastname"]', l_name);
          // Click input[name="firstname"]
  
          await page.click('input[name="firstname"]');
          // Fill input[name="firstname"]
          var f_name = makeid(1)+ makeids(Math.floor(Math.random()*(3)+5));
          ...
          // Select 1
          await page.selectOption('select[name="admin"]', '0');
          ...
          var name = "firstname" + String(Math.floor(Math.random()*(100)+100));
          await page.locator('input[role="searchbox"]').nth(1).fill(name);
          ...
          var name2 = "firstname" + String(Math.floor(Math.random()*(100)+100));
          await page.locator('input[role="searchbox"]').nth(1).fill(name2);
          // Press Enter
          await page.locator('input[role="searchbox"]').nth(1).press('Enter');
          ...
          await page.locator('input[role="searchbox"]').nth(1).click();
          // Fill input[role="searchbox"] >> nth=1
          var name3 = "firstname" + String(Math.floor(Math.random()*(100)+100));
          await page.locator('input[role="searchbox"]').nth(1).fill(name3);
          await page.locator('input[role="searchbox"]').nth(1).press('Enter');
          ...
          var addr = makeid(1) + makeids(Math.floor(Math.random()*(10)+10))
