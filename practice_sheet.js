...
//   }
  ...
  // Click text=Without contribution Up-to-date Out-of-date Out-of-date >> b[role="presentation"]
    // await page.locator('//html/body/div[3]/div[2]/div/form/div[2]/table/tbody/tr[1]/td[9]/span/span[1]/span/span[2]/b').click();
    //   // Click input[role="searchbox"]
    // await page.locator('input[role="searchbox"]').click();
    // // Fill input[role="searchbox"]
    // await page.locator('input[role="searchbox"]').fill('Up-');
    // // Press Enter
    ...
    for(var i =0;i<100;i++){
        await page.locator('input[name="search_company"]').click();
        // Fill input[name="search_company"]
        var cn = "Company"+String(Math.floor(Math.random()*(300)+1))
        await page.locator('input[name="search_company"]').fill(cn);
        ...
        await page.locator('text=Without contribution Up-to-date Out-of-date Without contribution >> b[role="presentation"]').click();
  // Click li[role="option"]:has-text("Up-to-date")
        await page.locator('li[role="option"]:has-text("Up-to-date")').click();
